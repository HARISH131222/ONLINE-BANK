...
<body background="background/istockphoto-528219721-612x612.jpg">
  ...
  <div class="wrapper">
    ...
    <class class="welcome">
        <h1 align="center" style="color: #FF0004; margin-left: 200px; background-color: aliceblue">
       ...
       <h2 class="text-center pt-4" style="color : black;">&nbsp;</h2>
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" style="background-color: aliceblue">Transfer</button>
            </div>
        </form>
    </div>    
